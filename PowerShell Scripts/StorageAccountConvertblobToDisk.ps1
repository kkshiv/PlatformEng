...
#Provide the name of the Managed Disk to be created
$diskName = '<DiskName>'
...
$vhdUri = '<https://contosostorageaccount1.blob.core.windows.net/vhds/contoso-um-vm120170302230408.vhd >'
...
$storageAccountId = '</subscriptions/6472s1g8-h217-446b-b509-314e17e1efb0/resourceGroups/MDDemo/providers/Microsoft.Storage/storageAccounts/contosostorageaccount>'
